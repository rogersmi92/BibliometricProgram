...
from processing.normalize import normalize_doi, normalize_records, parse_citations, parse_year
...
MPLCONFIG_DIR = os.path.join(PROJECT_DIR, "data", "visuals", ".mplconfig")
